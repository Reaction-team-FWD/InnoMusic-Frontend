  ...
  const handleProgressCommit = () => {
    if (audioRef.current && !isNaN(audioRef.current.duration)) {
      audioRef.current.currentTime =
        (audioRef.current.duration / 100) * sliderProgress;
    }
  };
